...
const SubApp = (
  ...
  <div>
    <PostFilter onClickPostFilterMy = {onClickPostFilterMy} onClickPostFilterOther = {onClickPostFilterOther} PostFilterMyColor={postFilterMyColor} PostFilterOtherColor={postFilterOtherColor} />
      { showOwnPost ?
        <PostList posts={ownPosts} current_user = {current_user} onDelete = {deletePost} updatePost = {updatePost}/>
        :
        <PostList posts={otherPosts} current_user = {current_user} onDelete = {deletePost} updatePost = {updatePost}/>
      }
